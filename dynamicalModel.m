function [DM,T01,T02,T03,q1,q2,q3,dq1,dq2,dq3] = dynamicalModel()
    syms q1 q2 q3
    syms l1 l2 l3
    ...
    %
    MASS = [2292.668, 583.341, 1167.569, ];
    HEIGHT = [156.502, 159.758, 492.517];
    CENTER_OF_MASS = [[-0.301; 1.127; 70.634], [10.879; -0.01 mm, 226.184 mm], [-24.195; -0.002; 480.492] ...
        ];
    
    % Moment of Inertia at Center of Mass
	Ixx = [5.263E+06, 1.902E+06, 2.870E+07, 
	Ixy = [2.418E+04, 9.402, -7.653, 
	Ixz = [2.709E+04, -2.331E+05, -43.188, 
	Iyx = [2.418E+04, 9.402, -7.653, 
	Iyy = [5.131E+06, 1.778E+06, 2.819E+07, 
	Iyz = [-2.362E+05, -98.997, -867.047, 
	Izx = [2.709E+04, -2.331E+05, -43.188, 
	Izy = [-2.362E+05, -98.997, -867.047, 
	Izz = [2.594E+06, 7.121E+05, 8.923E+05, 
