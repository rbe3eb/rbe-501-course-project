...
%   dispatcher object that both indicates the part exists and provides its
%   starting pose.


% Copyright 2020 The MathWorks, Inc.

% This function detects parts using a list in the dispatcher object that also provides the pose. 
